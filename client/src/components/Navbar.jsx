        ...
        relative transition-all${location.pathname === '/' && 'bg-light' }`}>
            ...
            <div className={`max-sm:fixed max-sm:h-screen max-sm:w-full max-sm:top-16 
                ...
                <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
                    ...
                    <button onClick={() => setShowlogin(true)}className="cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition-all text-black rounded-lg">Login</button>
                </div>
            </div>
